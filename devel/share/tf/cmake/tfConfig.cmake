...
if("TRUE" STREQUAL "TRUE")
  set(tf_SOURCE_PREFIX /home/kxu14/catkin_ws/src/tf)
  set(tf_DEVEL_PREFIX /home/kxu14/catkin_ws/devel)
  set(tf_INSTALL_PREFIX "")
  set(tf_PREFIX ${tf_DEVEL_PREFIX})
else()
  set(tf_SOURCE_PREFIX "")
  set(tf_DEVEL_PREFIX "")
  set(tf_INSTALL_PREFIX /home/kxu14/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kxu14/catkin_ws/src/tf/${idir}'.  ${_report}")
    endif()
